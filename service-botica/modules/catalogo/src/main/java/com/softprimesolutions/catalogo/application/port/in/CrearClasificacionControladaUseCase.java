...
@FunctionalInterface
public interface CrearClasificacionControladaUseCase {
    Result<ClasificacionControladaResult, ApplicationError> execute(CrearClasificacionControladaCommand command);
}
